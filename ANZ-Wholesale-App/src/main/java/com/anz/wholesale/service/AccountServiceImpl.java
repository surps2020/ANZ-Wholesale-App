...
public class AccountServiceImpl implements AccountService {
	...
	private static Map<String, AccountTranscation> AccountTranscationLists() {
		...
		transcations.put("123-2223-212", new AccountTranscation("123-2223-212", "CurrentAccount", "01/12/2012", "SGD",
				0.00, 9540.98, "Credit", ""));
		transcations.put("123-2223-213", new AccountTranscation("123-2223-213", "SavingAccount", "01/12/2012", "SGD",
				0.00, 7492.22, "Credit", ""));
		return transcations;
	}
}
