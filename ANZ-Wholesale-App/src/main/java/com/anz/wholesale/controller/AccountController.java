...
@RequestMapping(value = "/accountList", method = RequestMethod.GET,consumes = "application/json", produces = "application/json")
...
@RequestMapping(value = "/transcationList", method = RequestMethod.GET, consumes = "application/json", produces = "application/json")
public List<AccountTranscation> getAlltranscationList(@RequestBody String accountNumber) {
